...
"""
from Falcon_official.common import split, merge, q                     # Import split and merge
from Falcon_official.ntt_constants import roots_dict_Zq, inv_mod_q     # Import constants useful for the FFT
